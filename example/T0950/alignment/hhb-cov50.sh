...
/storage/htc/bdm/zhiye/DNCON4_db_tools/tools//hhsuite-3.0-beta.3-Linux/bin/hhblits -i T0950.fasta -d /storage/htc/bdm/zhiye/DNCON4_db_tools/databases//uniclust30_2017_10/uniclust30_2017_10 -oa3m T0950.a3m -cpu 8 -n 3 -diff inf -e 0.001 -id 99 -cov 50 > hhb-cov50-hhblits.log
cp T0950.a3m hhb-cov50.a3m
if [ ! -f "T0950.a3m" ]; then
   mv hhb-cov50.running hhb-cov50.failed
   echo "hhblits job hhb-cov50 failed!"
   exit
fi
egrep -v "^>" T0950.a3m | sed 's/[a-z]//g' > hhb-cov50.aln
