...
/storage/htc/bdm/zhiye/DNCON4_db_tools/tools//hhsuite-3.0-beta.3-Linux/bin/hhblits -i T0771.fasta -d /storage/htc/bdm/zhiye/DNCON4_db_tools/databases//uniclust30_2017_10/uniclust30_2017_10 -oa3m T0771.a3m -cpu 8 -n 3 -diff inf -e 0.001 -id 99 -cov 50 > hhb-cov50-hhblits.log
