...
path_of_lists   = '/storage/htc/bdm/zhiye/DNCON4/data/DEEPCOV/lists-test-train-6463-144/' #GLOBAL_PATH+'/data/'+dataset+'/lists-test-train/'
...
best_acc=DNCON4_1d2dconv_train_win_filter_layer_opt_fast_2D_generator(feature_num,CV_dir,feature_dir,net_name,out_epoch,in_epoch,rerun_epoch, filtsize,
