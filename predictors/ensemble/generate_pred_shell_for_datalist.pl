...
while(<IN>)
{
  ...
  print SH "models_dir[0]=\$global_dir/models/pretrain/dncon4_v3rc/1.dres152_deepcov_cov_ccmpred_pearson_pssm/\n";
  print SH "models_dir[1]=\$global_dir/models/pretrain/dncon4_v3rc/2.dres152_deepcov_plm_pearson_pssm/\n";
  print SH "models_dir[2]=\$global_dir/models/pretrain/dncon4_v3rc/3.res152_deepcov_pre_freecontact/\n";
  print SH "models_dir[3]=\$global_dir/models/pretrain/dncon4_v3rc/4.res152_deepcov_other/\n";

  print SH "output_dir=$run_outdir\n";
  print SH "fasta=/storage/htc/bdm/zhiye/DNCON4/predictors/results/CASP13_dncon4_v3rc_domain/$line.fasta\n";
